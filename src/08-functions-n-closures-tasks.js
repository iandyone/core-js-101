...
function logger(func, logFunc) {
  return (...params) => {
    const str = JSON.stringify(params).slice(1, -1);
 ...
 *   partialUsingArguments(fn, 'a','b','c','d')() => 'abcd'
 */
function partialUsingArguments(fn, ...params) {
  return (...args) => fn(...params, ...args);
}
